...
E..vtable:              ## virtual function table for E
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl F..vtable
F..vtable:              ## virtual function table for F
                        .quad string7
                        .quad F..new
                        .quad Object.abort
                        .quad Object.copy
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl G..vtable
G..vtable:              ## virtual function table for G
                        .quad string8
                        .quad G..new
                        .quad Object.abort
                        .quad Object.copy
...
String..vtable:         ## virtual function table for String
                        ...
                        ## ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.globl Z..vtable
Z..vtable:              ## virtual function table for Z
                        .quad string14
                        .quad Z..new
                        .quad Object.abort
                        .quad Object.copy
...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        popq %rbp
                        movq %r13, 32(%r12)
                        ## self[5] holds field z (IO)
                        movq $0, %r13
                        movq %r13, 40(%r12)
                        ## self[6] holds field a (A)
                        movq $0, %r13
                        movq %r13, 48(%r12)
...
.globl string17
string17:               # "ERROR: 21: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string18
string18:               # "ERROR: 22: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string20
string20:               # "ERROR: 23: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
